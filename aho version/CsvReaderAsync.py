...
class CsvReaderAsync(Thread):
    def __init__(self, onReadChunk, onFinishReading, filename, chunkSize, sharedDict):
        super().__init__()
    ...
    def read(self):
        ...
        with pd.read_csv(self.filename,na_filter=False, on_bad_lines='skip',nrows=50000, chunksize=self.chunkSize, encoding="ISO-8859-1",
